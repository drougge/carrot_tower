...
spawns = [[(Chainsaw, 3, "green"     , 3 , spawn_points[0][0], 30, 300),
           (Chainsaw, 6, "blue"      , 5 , spawn_points[0][0], 30, 300),
           (Chainsaw, 6, "red"       , 7 , spawn_points[0][0], 30, 300),
           (Ext,      1, "pink"      , 36, spawn_points[0][0], 30, 300),
           (Chainsaw, 6, "blue"      , 10, spawn_points[0][0], 30, 300),
           (Chainsaw, 6, "red"       , 14, spawn_points[0][0], 30, 300),
           (SmartChainsaw, 1, "black", 24, spawn_points[0][0], 30, 300),
           ...
           (Ext,      1, "pink"      , 360,spawn_points[0][0], 30, 300, {"bounty": 239}),
          ...
          [(Chainsaw, 13, "blue"     , 12, spawn_points[2][0], 25, 300),
           (SmartChainsaw, 3, "black", 24, spawn_points[2][0], 25, 300),
           (Chainsaw, 6, "red"       , 50, spawn_points[2][0], 30, 300),
           (Chainsaw, 6, "green"     , 72, spawn_points[2][0], 30, 300),
           (Ext,      1, "pink"      , 360,spawn_points[2][0], 30, 300),
           (Chainsaw, 6, "red"       , 58, spawn_points[2][0], 30, 300),
           (Chainsaw, 6, "blue"      , 36, spawn_points[2][1], 30, 300),
           (Chainsaw, 6, "green"     , 72, spawn_points[2][0], 30, 300),
           (Chainsaw, 8, "green"     , 72, spawn_points[2][0], 20, 0),
           (Chainsaw, 10, "blue"     , 36, spawn_points[2][1], 20, 300),
           (SmartChainsaw, 3, "black", 50, spawn_points[2][1], 30, 300),
           (SmartChainsaw, 3, "black", 72, spawn_points[2][0], 30, 300),
           (Chainsaw, 6, "red"       , 100,spawn_points[2][0], 30, 300),
           (Chainsaw, 12, "red"      , 120,spawn_points[2][0], 30, 300),
          ],
          [(Chainsaw, 3, "blue"      , 3,  spawn_points[3][0], 25, 300, {"bias": -1}),
           (Chainsaw, 3, "green"      , 3,  spawn_points[3][0], 20, 0,   {"bias": -1}),
           (Chainsaw, 3, "red"      , 3,  spawn_points[3][1], 20, 200, {"bias":  1}),
           (Dammsugare, 2, "blue"    , 300,spawn_points[3][0], 60, 300, {"bias": -1}),
           (Chainsaw, 3, "green"      , 3,  spawn_points[3][1], 10, 100, {"bias":  1}),
           (Chainsaw, 3, "red"      , 3,  spawn_points[3][1], 5,  50,  {"bias":  1}),
